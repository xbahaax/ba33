  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <span className="hidden font-medium lg:block">Noura Fibres</span>
          ...
          <div className="border-b border-border px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate text-sm font-semibold text-foreground">Noura Fibres</p>
                <p className="truncate font-mono text-xs text-muted-foreground">contact@nourafibres.dz</p>
              </div>
            </div>
          </div>
