...
Read `.Codex/rules.md` for the full cahier des charges and `.Codex/code_architecture.md` for the architecture plan.
...
Read `.Codex/desiegn_system.md` for the full design system specification.
